...
//RT//module ALU32Bit(ALUControl, A, B, clk,  ALUResult, Zero);
module ALU32Bit(ALUControl, A, B, ALUResult, Zero);
	input [3:0] ALUControl; // control bits for ALU operation
	//RT//input signed [31:0] A, B;
	input [31:0] A, B;     //RT// No need to do signed
	
	//RT//input clk;	    // inputs

	//RT//output reg signed [31:0] ALUResult;	// answer
    ...
    //always @ (posedge clk)  //WRONG IDEA FOR THIS
    ...
    begin
        ...
        // ROTATE RIGHT   | 1010 | ALUResult = A ROTR B     (see notes below)
        4'b1010: begin
            //RT//use the statement given in the comments    
